			...
			<div class="list-group">
				<a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">Google Analytics para iniciantes</h5>
				...
				<a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">Curso avançado do Google Analytics</h5>
					...
					<small class="text-muted">#GoogleAnalytics</small>
				</a>
				<a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">Começar a usar o Google Analytics 360</h5>
						<small class="text-muted">Português</small>
					</div>
					<p class="mb-1">
                ...
                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">Fundamentos do Gerenciador de tags do Google</h5>
						<small class="text-muted">Português</small>
					</div>
					<p class="mb-1">
					...
					<small class="text-muted">#GTM</small>
				</a>
                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">Google Analytics for Beginners</h5>
						<small class="text-muted">Inglês</small>
					</div>
					<p class="mb-1">
                ...
                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">Advanced Google Analytics</h5>
						<small class="text-muted">Inglês</small>
					</div>
					<p class="mb-1">
                ...
                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">Google Analytics for Power Users</h5>
						<small class="text-muted">Inglês</small>
					</div>
					<p class="mb-1">
                ...
                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">Getting Started With Google Analytics 360</h5>
						<small class="text-muted">Inglês</small>
					</div>
					<p class="mb-1">
                ...
                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">Introduction to Data Studio</h5>
						<small class="text-muted">Inglês</small>
					</div>
					<p class="mb-1">
					...
					<small class="text-muted">#DataStudio</small>
				</a>
                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">Google Tag Manager Fundamentals</h5>
						<small class="text-muted">Inglês</small>
					</div>
					<p class="mb-1">
                ...
                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">Measure Your Marketing with Google Analytics</h5>
						<small class="text-muted">Inglês</small>
					</div>
					<p class="mb-1">
					...
					<small class="text-muted">#GA4</small>
				</a>
                <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
					<div class="d-flex w-100 justify-content-between">
						<h5 class="mb-1">Go Further with Your Google Analytics Data</h5>
						<small class="text-muted">Inglês</small>
					</div>
					<p class="mb-1">
