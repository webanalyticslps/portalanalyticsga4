          ...
          >
            <div className="accordion-body">
              ...
              <ul className="list-group list-group-flush">
                <li className="list-group-item"> Selecione o tipo de evento que irá ser tagueado. Você pode consultar todos os possíveis eventos na aba "Documentações -> Eventos" do portal.</li>
                <li className="list-group-item"> Selecione o site em que o seu evento será disparado.</li>
                <li className="list-group-item"> Selecione o container em que o seu evento será disparado.</li>
                <li className="list-group-item"> Selecione o subcontainer em que o seu evento será disparado.</li>
                <li className="list-group-item"> Selecione o identificador do seu evento.</li>
				<li className="list-group-item"> Clique no botão "Criar" e atualize a página.</li>
              </ul>
				<p/>
